            ...
            <div className="container">
                <div className="row">
                    ...
                    <div className="col-lg-6 offset-6">
                        ...
                        <p>Планировка квартир в жилом комплексе «Nukus Avenue» продумана до мелочей для удобного проживания. Внутренний дизайн интерьера квартиры каждый может сделать под себя, чтобы каждая деталь в доме органично дополняла другие.</p>
                    </div>
                </div>
            </div>
        </div>
